...
public class CalendarAPIActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendarapi);
...
//     */
//    @Override
//    public void onPermissionsGranted(int requestCode, @NonNull List<String> requestPermissionList) {
//
//
//        // 아무일도 하지 않음
//    }
...
//     */
//    @Override
//    public void onPermissionsDenied(int requestCode, @NonNull List<String> requestPermissionList) {
//
//        // 아무일도 하지 않음
//    }
...
//        Activity myActivity
        do {
            ...
            List<CalendarListEntry> items = calendarList.getItems(); // 오류발생
